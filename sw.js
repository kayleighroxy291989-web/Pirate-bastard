const CACHE="pirate-bastard-character-realism-v14";
const ASSETS=["./","./index.html","./manifest.json","./icon.svg","./pirate_hit.mp3","./pirate_miss_1.mp3","./pirate_miss_2.mp3","./shooter_bullseye.mp3","./shooter_gotcha.mp3"];
